<footer class="inner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="fb-page" data-href="https://www.facebook.com/ccriku/" data-tabs="timeline" data-height="200" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                    <blockquote cite="https://www.facebook.com/ccriku/" class="fb-xfbml-parse-ignore">
                        <a href="https://www.facebook.com/ccriku/">RRNiCocorikuj</a>
                    </blockquote>
                </div>
                <div id="fb-root"></div>
                <script>(function(d, s, id) {
                        ...
                        js.src = "//connect.facebook.net/ja_JP/sdk.js#xfbml=1&version=v2.8&appId=1704445309835279";
            ...
            <div class="col-md-4">
                <div class="contact-details">
                    <h4>Contact Us</h4>
                    <ul class="contact">
                        <li><p><i class="icon icon-map-marker"></i> <strong>Address:</strong>
                        4F Sunrise building, 25 2/9 street Hai Chau, Da Nang, Viet Nam</p></li>
                        <li><p><i class="icon icon-envelope"></i> <strong>Email:</strong> <a href="about/contact_us.htm">Click Here</a></p></li>
                        <li><p><i class="icon icon-dribbble"></i> <strong>Website:</strong> <a href="http://minaworks.vn">http://minaworks.vn</a></p></li>
                    </ul>
                </div>
      ...
      <div class="footer-copyright">
          <div class="container">
              <div class="row">
                  <div class="col-md-1">
                      <a href="index.htm" class="logo"> <img alt="Tutorials Point" class="img-responsive" src="/assets/client/theme/images/logo-footer.png"> </a>
                  </div>
