<header>
    <div class="container">         
      ...
      <img alt="tutorialspoint" src="/assets/client/theme/images/logo.png">
      </a>
      </h1>         
      <nav>
         <ul class="nav nav-pills nav-top">
            ...
            <li> <a href="https://www.tutorialspoint.com/whiteboard.htm"><img src="/assets/client/theme/images/icon/image-editor.png" alt="Whiteboard" title="Whiteboard"> &nbsp;Whiteboard</a> </li>
            ...
            <li>
                <div id="language" class="language w-106" data-input-name="country"></div>
            </li>
            <li class="login">
                <a href="javascript:void(0);" class="btn btn-default h-34-w-70" id="modalLogin">Login</a>
            </li>
            <li class="signup">
                <a href="javascript:void(0);" class="btn btn-default h-34-w-70" id="modalSignUp">Sign Up</a>
            </li>
         </ul>
      </nav>
         <!-- search code here  --> 
