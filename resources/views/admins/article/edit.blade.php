                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-10 col-sm-offset-2">
                                <div class="checkbox">
                                    <label>{{ Form::checkbox('is_sesson', '1', $article->is_sesson,['class' => 'jsSesson']) }} Sesson</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group {!! !empty($article->is_sesson) ? '' : 'jsDisabled' !!} jsTimeTracking">
                            ...
                            <div class="col-sm-3">
                                {{ Form::text('time_tracking', $article->time_tracking, ['class'=>'form-control', 'min' => 0]) }}
                            </div>                           
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Trạng thái</label>
                            <div class="col-sm-3">
                                {{ Form::select('status', App\Article::TYPE_STATUS, $article->status, ['placeholder' => '---Choice---','class'=>'form-control']) }}
                            </div>
                        </div>
                    </div>
