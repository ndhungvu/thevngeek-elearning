...
@section('content')
<link rel="stylesheet" href="{{ asset('assets/client/theme/css/blog.css?v=2') }}">
<div role="main" class="main">
    <div class="st-banner">
        <div class="container">
           <div class="row center middle">
              <div class="col-md-12">
                    <h2 style="top:-10px; color:white; font-size:1.7em; text-shadow:none;"><img src="/assets/client/theme/images/slide-title-border.png" alt="" style="width:37px; height:10px; position:relative; top:-2px;">&nbsp;&nbsp; Enjoy theory and lab at the same time, right here online &nbsp;&nbsp;<img src="/assets/client/theme/images/slide-title-border.png" alt="" style="width:37px; height:10px; position:relative; top:-2px;"></h2>
                    <div style="margin-top:20px;">
                       <span class="srch-icon"><a href="/ruby-on-rails/index.htm" title="Ruby on Rails Tutorial"><img src="/assets/client/theme/images/ruby-on-rails.png" alt="Ruby on Rails tutorial"/></a></span>
                       <span class="srch-icon"><a href="/google_maps/index.htm" title="Google Maps Tutorial"><img src="/assets/client/theme/images/googlemaps.png" alt="Google Maps Tutorial"/></a></span>
                       <span class="srch-icon"><a href="/data_structures_algorithms/index.htm" title="Data Structure & Algorithms Tutorial"><img src="/assets/client/theme/images/data_structure.png" alt="Data Structure & Algorithms Tutorial"/></a></span>
                       <span class="srch-icon"><a href="/joomla/index.htm" title="Joomla Tutorial"><img src="/assets/client/theme/images/joomla.png" alt="Joomla Tutorial"/></a></span>
                       <span class="srch-icon"><a href="/drupal/index.htm" title="Drupal Tutorial"><img src="/assets/client/theme/images/drupal.png" alt="Drupal tutorial"/></a></span>
                       <span class="srch-icon"><a href="/r/index.htm" title="R Programming Tutorial"><img src="/assets/client/theme/images/r-programming.png" alt="R Programming tutorial"/></a></span>
                       <span class="srch-icon"><a href="/apache_spark/index.htm" title="Spark Tutorial"><img src="/assets/client/theme/images/spark.png" alt="Spark tutorial"/></a></span>
                       <span class="srch-icon"><a href="/nodejs/index.htm" title="Node.js"><img src="/assets/client/theme/images/node.js.png" alt="Nodejs tutorial"/></a></span>
                    </div>
                    <h6>The largest <em>Tutorials Library</em> on the web</h6>
              </div>
           </div>
        </div>
    </div>
...
<div class="tutor-connect">
   <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4">            
          <a href="https://www.tutorialspoint.com/tutor_connect/index.php" target="_self">
           <h2><i class="fa-caret-right"></i> Are you passionate about teaching</h2>
           <p>Join us to connect with millions of learners around the globe to teach and earn extra income.</p>
          </a>                      
          <a href="https://www.tutorialspoint.com/tutor_connect/index.php" target="_self">
          <h2><i class="fa-caret-right"></i> Looking for qualified tutors? </h2>
          <p>We connect you with qualified tutors to save your time and money. </p>
          </a>            
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-5">
          <a href="https://www.tutorialspoint.com/tutor_connect/index.php" target="_self">
            <h2><i class="fa-caret-right"></i> Online or Offline Classes </h2>
            <p>You can opt for online or offline classes based on <br>your preferences.</p>
          </a>
          <a href="https://www.tutorialspoint.com/tutor_connect/index.php" target="_self">
            <h2><i class="fa-caret-right"></i> No Commission, No Fee, Free Service</h2>
            <p>We help tutors and students to connect together without any service charges.</p>
          </a>
        </div>               
      </div>
   </div>
...
<div class="absolutecls" style="background: #001E28 url(/assets/client/theme/images/learn-home.jpg); margin: 0px 0 4px 0;">
   <div class="container">
      <div class="row">
         <h2>Coding Ground</h2>
         <h2><img src="/assets/client/theme/images/slide-title-border.png" alt="" style="width:37px; height:10px; position:relative; top:-2px;">&nbsp;&nbsp; An online Lab for IT Professionals &nbsp;&nbsp;<img src="/assets/client/theme/images/slide-title-border.png" alt="" style="width:37px; height:10px; position:relative; top:-2px;"></h2>
         <p>With <b>Coding Ground</b> we bring an Online Lab where you can create your programs in more than 80 programming languages, compile, execute and share them over the web, which provides you remarkable learning experience at a cost of just an internet connection!</p>
         <div style="width:100%; text-align:center;"><a href="codingground.htm" title="Coding Ground" class="btn btn-default btn-sm btn-job-search"> Start Experimenting </a></div>
      </div>
    </div>
</div>
